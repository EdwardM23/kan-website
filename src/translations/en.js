export const translations = {
  ...
  hero: {
    ...
    description: "We deliver exceptional work and craftsmanship tailored to your needs, let's build your extraordinary vision into reality together!",
  ...
  services: {
    title: "Our Services",
    fitOut: {
      title: "Fit Out (Commercial & Retail Spaces)",
      description: "Transforming empty shells and spaces into functional environments, we specialize in turnkey interior fit outs for malls, offices, and retail spaces."
    },
    interiorDesign: {
    ...
    construction: {
      ...
      description: "From commercial buildings, large scale projects, and residential, we build almost anything."
    }
  },
  footer: {
