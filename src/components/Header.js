...
function Header() {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 flex items-center bg-white/30 backdrop-blur-sm justify-between px-8 py-4 z-10 transition-colors duration-300 ${isScrolled ? 'bg-white shadow-md' : 'bg-none'}`}>
